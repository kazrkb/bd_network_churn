-- Note: You may not need this script since we already filled missing values in the CSV!
-- However, here is the exact MySQL translation of your SQL Server script if needed.

CREATE TABLE bd_churn.prod_customer_data AS
SELECT 
    Customer_ID,
    Gender,
    Age,
