...
# ---------------------------------------------------------
# PREDICTION ON NEW DATA (vw_JoinData)
# ---------------------------------------------------------
...
# Filter the DataFrame to include only records predicted as "Churned" (1)
